...
var InitCategory = function InitCategory(_ref) {
  var _paginated$map;
  var use = _ref.use,
  ...
  var ButtonUpdate = function ButtonUpdate(_ref2) {
    ...
    return /*#__PURE__*/_react["default"].createElement("div", {
      ...
      buttonProps: {
        onClick: function onClick() {
          return use.actions.deleteCategory(id);
        }
      }
    }, deleteButtonProps)));
  };
  var filtered = use.actions.filterByName(use.states.category.data.items, use.states.searchTerm);
  ...
  return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement(_Header.Header, (0, _extends2["default"])({
    title: "Categor\xEDas de Productos",
    buttonLargeProps: {
