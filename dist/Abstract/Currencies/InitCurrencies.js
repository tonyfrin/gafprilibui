...
var InitCurrencies = function InitCurrencies(_ref) {
  ...
  var ButtonUpdate = function ButtonUpdate(_ref2) {
    ...
    return /*#__PURE__*/_react["default"].createElement("div", {
      ...
      buttonProps: {
        onClick: function onClick() {
          return use.actions.deleteCurrency(id);
        }
      }
    }, deleteButtonProps)));
  };
  var filteredCurrencies = use.actions.filterCurrenciesByName(use.states.searchTerm);
  var currencies = use.actions.sortCurrenciesByName(filteredCurrencies, use.states.orderList) || [];
  var paginatedCurrencies = use.actions.getPaginatedCurrencies(currencies, use.states.currentPage, use.states.itemsPerPage);
  var items = (_paginatedCurrencies$ = paginatedCurrencies === null || paginatedCurrencies === void 0 ? void 0 : paginatedCurrencies.map(function (item) {
    return [item.name, item.symbol, /*#__PURE__*/_react["default"].createElement(ButtonUpdate, {
      id: item.id
    })];
  })) !== null && _paginatedCurrencies$ !== void 0 ? _paginatedCurrencies$ : [];
  var headers = ['Nombre', 'Simbolo', 'Opciones'];
  var options = [{
    value: 'asc',
    label: 'Ascendente'
  }, {
  ...
  var totalPages = Math.ceil(currencies.length / use.states.itemsPerPage);
