...
exports.EntityExpensesSearchForm = void 0;
...
var _templateObject;
var entityExpensesSearchFormStaylesContainer = function entityExpensesSearchFormStaylesContainer(styles) {
  return (0, _css.css)(_templateObject || (_templateObject = (0, _taggedTemplateLiteral2["default"])(["\n  color: ", ";\n  font-size: ", ";\n  padding-bottom: ", ";\n  ", "\n"])), styles.color || '#616e7d', styles.fontSize || '12px', styles.paddingBottom || '40px', styles.custom || '');
};
var EntityExpensesSearchForm = exports.EntityExpensesSearchForm = function EntityExpensesSearchForm(_ref) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement("div", (0, _extends2["default"])({
    className: (0, _css.cx)(entityExpensesSearchFormStaylesContainer(containerStyles), containerClassName)
    ...
    props: {
      ...
      inputProps: {
        title: 'Cedula o RIF',
        onKeyPress: useExpenses.pages.actions.processEntityBydocumentId
      }
    }
