...
var iconContentStyle = function iconContentStyle(styles) {
  return (0, _css.css)(_templateObject2 || (_templateObject2 = (0, _taggedTemplateLiteral2["default"])(["\n  font-family: ", ";\n  font-weight: ", ";\n  color: ", ";\n  text-transform: ", ";\n  background-color: ", ";\n  overflow: ", ";\n  text-align: ", ";\n  width: ", ";\n  height: ", ";\n  border-radius: ", ";\n  font-size: ", ";\n  display: ", ";\n  vertical-align: ", ";\n  margin: ", ";\n  padding: ", ";\n  border: ", ";\n  border-spacing: ", ";\n  border-collapse: ", ";\n  ", "\n"])), styles.fontFamily || 'inherit', styles.fontWeight || '100', styles.color || 'rgb(50, 79, 165)', styles.textTransform || 'uppercase', styles.backgroundColor || 'rgb(232, 239, 250)', styles.overflow || 'hidden', styles.textAlign || 'center', styles.width || '3rem', styles.height || '3rem', styles.borderRadius || '70% 52% 72%', styles.fontSize || '1.5rem', styles.display || 'inline-block', styles.verticalAlign || 'middle', styles.margin || '0.5rem', styles.padding || '0', styles.border || '0', styles.borderSpacing || '0', styles.borderCollapse || 'collapse', styles.custom || '');
};
...
var iconContentTitleStyle = function iconContentTitleStyle(styles) {
  return (0, _css.css)(_templateObject6 || (_templateObject6 = (0, _taggedTemplateLiteral2["default"])(["\n  font-family: ", ";\n  font-weight: ", ";\n  font-size: ", ";\n  color: ", ";\n  margin: ", ";\n  padding: ", ";\n  border: ", ";\n  vertical-align: ", ";\n  border-spacing: ", ";\n  border-collapse: ", ";\n  background: ", ";\n  ", "\n"])), styles.fontFamily || "Circular, ProximaNova, -apple-system, BlinkMacSystemFont,\n  'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Fira Sans', 'Droid Sans',\n  'Helvetica Neue', sans-serif", styles.fontWeight || '800', styles.fontSize || '1em', styles.color || 'rgb(38, 35, 33)', styles.margin || '0', styles.padding || '0', styles.border || '0', styles.verticalAlign || 'top', styles.borderSpacing || '0', styles.borderCollapse || 'collapse', styles.background || 'transparent', styles.custom || '');
};
