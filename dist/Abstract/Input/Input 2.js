...
var Input = function (_a) {
    var _b = _a.styles, styles = _b === void 0 ? {} : _b, _c = _a.inputClass, inputClass = _c === void 0 ? '' : _c, _d = _a.inputProps, inputProps = _d === void 0 ? {} : _d, _e = _a.containerStyles, containerStyles = _e === void 0 ? {} : _e, _f = _a.containerClass, containerClass = _f === void 0 ? '' : _f;
    return (react_1.default.createElement(Containers_1.ContainerInput, { styles: containerStyles, containerClass: containerClass },
...
var GsSelect = function (_a) {
    var _b = _a.styles, styles = _b === void 0 ? {} : _b, _c = _a.Class, Class = _c === void 0 ? '' : _c, options = _a.options, id = _a.id, onChange = _a.onChange, placeholder = _a.placeholder, _d = _a.containerStyles, containerStyles = _d === void 0 ? {} : _d, _e = _a.containerClass, containerClass = _e === void 0 ? '' : _e, defaultValue = _a.defaultValue;
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(Containers_1.ContainerInput, { styles: containerStyles, containerClass: containerClass },
