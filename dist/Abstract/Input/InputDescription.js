...
var InputDescription = function InputDescription(_ref) {
  var changeDescription = _ref.changeDescription,
    props = _ref.props,
  ...
  return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement(_Input.Input, {
    ...
    inputProps: _objectSpread({
      ...
      type: 'text',
      id: "".concat(_constants.DESCRIPTION_INPUT).concat(inputId),
      onKeyUp: function onKeyUp(event) {
        return changeDescription(event.currentTarget.value);
      }
