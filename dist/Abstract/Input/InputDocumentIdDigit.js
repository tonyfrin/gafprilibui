...
exports.InputDocumentiIdDigit = void 0;
...
var InputDocumentiIdDigit = function InputDocumentiIdDigit(_ref) {
  var changeDocumentiIdDigit = _ref.changeDocumentiIdDigit,
    props = _ref.props,
  ...
  return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement(_Input.Input, {
    ...
    inputProps: _objectSpread({
      ...
      id: "".concat(_constants.TYPE_DOCUMENT_ID_DIGIT_INPUT).concat(inputId),
      onKeyUp: function onKeyUp(event) {
        return changeDocumentiIdDigit(event.currentTarget.value);
      }
...
exports.InputDocumentiIdDigit = InputDocumentiIdDigit;