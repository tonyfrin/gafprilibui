...
var Step = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: (0, css_1.cx)(StepStyles(styles), Class) },
        ...
        react_1.default.createElement(Containers_1.ContainerButton, { styles: containerButtonStyles, Class: containerButtonClass },
            react_1.default.createElement(react_1.default.Fragment, null,
                buttonReturnTitle ?
                    react_1.default.createElement(Button_1.Button, { styles: buttonReturnStyles, buttonProps: buttonReturnProps, Class: buttonReturnClass, title: buttonReturnTitle }) : '',
                buttonNextTitle ?
                    react_1.default.createElement(Button_1.Button, { styles: buttonNextStyles, buttonProps: buttonNextProps, Class: buttonNextClass, title: buttonNextTitle }) : ''))));
};
exports.Step = Step;
