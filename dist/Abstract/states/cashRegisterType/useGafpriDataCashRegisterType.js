...
exports.useGafpriDataCashRegisterType = useGafpriDataCashRegisterType;
...
function useGafpriDataCashRegisterType(_ref) {
  var _items$data;
  ...
  var _useState3 = (0, _react.useState)({
      data: {
        items: (0, _Context.getItem)(_constants.CASH_REGISTER_TYPE_STORAGE, null)
      }
    }),
  ...
  var setDataStorage = function setDataStorage(newData) {
    (0, _Context.saveItem)(_constants.CASH_REGISTER_TYPE_STORAGE, newData.data.items);
  };
    ...
    var _ref2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee() {
      ...
      return _regenerator["default"].wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _helpers.getLastEntryDateAndCount)(_constants.CASH_REGISTER_TYPE_ROUTE);
          case 2:
