...
exports.useGafpriAttributesOrderItems = useGafpriAttributesOrderItems;
...
function useGafpriAttributesOrderItems(_ref) {
  ...
  var uploadBudgetItems = function uploadBudgetItems(budgetItems) {
    budgetItems.forEach(function (orderItem) {
