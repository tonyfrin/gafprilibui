...
exports.useGafpriPaginationsProjects = useGafpriPaginationsProjects;
...
function useGafpriPaginationsProjects(_ref) {
  var data = _ref.data;
  ...
  var filterByName = function filterByName(search) {
    if (data.states.items && data.states.items.data.items) {
      return data.states.items.data.items.filter(function (project) {
