...
exports.useGafpriPaginationsShippingMethods = useGafpriPaginationsShippingMethods;
...
function useGafpriPaginationsShippingMethods() {
  ...
  var filterByName = function filterByName(search, currentItems) {
    if (currentItems) {
