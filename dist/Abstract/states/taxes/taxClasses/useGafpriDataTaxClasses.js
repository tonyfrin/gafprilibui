...
exports.useGafpriDataTaxClasses = useGafpriDataTaxClasses;
...
function useGafpriDataTaxClasses(_ref) {
  var _items$data;
  ...
  var _useState3 = (0, _react.useState)({
      data: {
        items: (0, _Context.getItem)(_constants.TAX_CLASSES_STORAGE, null)
      }
    }),
  ...
  var setDataStorage = function setDataStorage(newData) {
    (0, _Context.saveItem)(_constants.TAX_CLASSES_STORAGE, newData.data.items);
  };
    ...
    var _ref2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee() {
      ...
      return _regenerator["default"].wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _helpers.getLastEntryDateAndCount)(_constants.TAX_CLASSES_ROUTER);
          case 2:
  ...
  var handleUpdated = function handleUpdated(updatedItem) {
    setItems(function (prevState) {
      ...
      var updatedItems = ((_prevState$data$items = prevState.data.items) === null || _prevState$data$items === void 0 ? void 0 : _prevState$data$items.map(function (item) {
        return "".concat(item.id) === "".concat(updatedItem.id) ? updatedItem : item;
      })) || [];
      var newData = {
        data: {
          items: updatedItems
  ...
  function getOptions() {
    ...
    var options = [];
    (_items$data$items3 = items.data.items) === null || _items$data$items3 === void 0 ? void 0 : _items$data$items3.forEach(function (item) {
      options.push({
        label: item.name,
