...
var mainStyle = function mainStyle(styles) {
  ...
  return (0, _css.css)(_templateObject || (_templateObject = (0, _taggedTemplateLiteral2["default"])(["\n  display: ", ";\n  justify-content: ", ";\n  padding: ", ";\n\n  @media (max-width: 600px) {\n    padding: ", ";\n  }\n\n  @media (max-width: 300px) {\n    padding: ", ";\n  }\n"])), styles.display || 'flex', styles.justifyContent || 'center', styles.padding || '170px', ((_styles$media600Style = styles.media600Style) === null || _styles$media600Style === void 0 ? void 0 : _styles$media600Style.padding) || '130px', ((_styles$media300Style = styles.media300Style) === null || _styles$media300Style === void 0 ? void 0 : _styles$media300Style.padding) || '90px');
};
