...
var MainCategory = function MainCategory(_ref) {
  ...
  }, /*#__PURE__*/_react["default"].createElement(_Abstract.InitCategory, (0, _extends2["default"])({
    use: use
  }, initProps))), use.states.isAdd && /*#__PURE__*/_react["default"].createElement(_Abstract.FadeIn, {
    keyName: "add",
    isVisible: use.states.isAdd
  }, /*#__PURE__*/_react["default"].createElement(_Abstract.CategoryForm, (0, _extends2["default"])({
    use: use,
    formType: "add"
