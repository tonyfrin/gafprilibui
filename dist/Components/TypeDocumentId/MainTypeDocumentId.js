...
exports.MainTypeDocumentId = void 0;
...
var MainTypeDocumentId = function MainTypeDocumentId(_ref) {
  ...
  }, /*#__PURE__*/_react["default"].createElement(_Abstract.InitTypeDocumentId, (0, _extends2["default"])({
    use: use
  }, initProps))), use.states.isAdd && /*#__PURE__*/_react["default"].createElement(_Abstract.FadeIn, {
    keyName: "add",
    isVisible: use.states.isAdd
  }, /*#__PURE__*/_react["default"].createElement(_Abstract.TypeDocumentIdForm, (0, _extends2["default"])({
    use: use,
    formType: "add"
