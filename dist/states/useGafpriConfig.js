...
function useGafpriConfig() {
     ...
     *
     */
    var onConfig = function () { return dispatch({
        type: actionTypes.isConfig,
    }); };
    var onSites = function () { return dispatch({
        type: actionTypes.isSites,
    }); };
    //setear los valores de la Currencies
    var setCurrenciesName = function (value) { return dispatch({
        type: actionTypes.currencyName,
        payload: value
    }); };
    var setCurrenciesSymbol = function (value) { return dispatch({
        type: actionTypes.currencySymbol,
        payload: value
    }); };
    var setCurrenciesDefault = function (value) { return dispatch({
        type: actionTypes.currenciesDefault,
        payload: value
    }); };
    var setValidationCurrency = function (value) { return dispatch({
        type: actionTypes.validationCurrency,
        payload: value
    }); };
    var setButtonCurrency = function (value) { return dispatch({
