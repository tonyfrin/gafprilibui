export const AllRoles = [
  ...
  },
  {
    ...
    permissions: [
      { name: 'Obtener', value: 'order-return-paymentsCreate' },
      { name: 'Crear', value: 'order-return-paymentsUpdate' },
      { name: 'Actualizar', value: 'order-return-paymentsDelete' },
      { name: 'Borrar', value: 'order-return-paymentsGet' },
    ],
  },
];
