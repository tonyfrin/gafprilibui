export const AllRoles = [
  {
    ...
    permissions: [
      { name: 'Obtener', value: 'expenses-typeGet' },
      { name: 'Crear', value: 'expenses-typeCreate' },
      { name: 'Actualizar', value: 'expenses-typeUpdate' },
      { name: 'Borrar', value: 'expenses-typeDelete' },
    ],
  },
  {
    name: 'Proyectos',
  ...
  },
  {
    ...
    permissions: [
      { name: 'Obtener', value: 'bank-typeGet' },
      { name: 'Crear', value: 'bank-typeCreate' },
  ...
  },
  {
    ...
    permissions: [
      { name: 'Obtener', value: 'cash-register-typeGet' },
      { name: 'Crear', value: 'cash-register-typeCreate' },
      { name: 'Actualizar', value: 'cash-register-typeUpdate' },
      { name: 'Borrar', value: 'cash-register-typeDelete' },
      { name: 'Conciliar', value: 'cash-register-typeConciliate' },
    ],
  },
  {
    name: 'Monedas',
  ...
  },
  {
    ...
    permissions: [
      { name: 'Obtener', value: 'accounts-receivableGet' },
      { name: 'Crear', value: 'accounts-receivableCreate' },
  ...
  },
  {
    name: 'Egresos',
    permissions: [
      { name: 'Obtener', value: 'expensesGet' },
      { name: 'Crear', value: 'expensesCreate' },
    ],
  },
  {
    name: 'Ingresos',
    permissions: [
      { name: 'Obtener', value: 'incomeGet' },
      { name: 'Crear', value: 'incomeCreate' },
    ],
  },
  {
    name: 'Pedidos',
    permissions: [
      ...
      { name: 'Cancelar', value: 'ordersDelete' },
    ],
  },
  {
    name: 'Pagos de créditos',
    permissions: [{ name: 'Crear', value: 'payment-creditCreate' }],
  },
  {
    name: 'Pagos de pedidos',
    permissions: [{ name: 'Crear', value: 'payment-orderCreate' }],
  },
  {
    name: 'Pagos de devolución de pedidos',
    permissions: [{ name: 'Crear', value: 'payment-order-returnCreate' }],
  },
  {
    name: 'Transferencias entre bancos',
    permissions: [{ name: 'Crear', value: 'payment-transfer-bankCreate' }],
  },
  {
    name: 'Transferencias entre cajas',
    permissions: [
      { name: 'Crear', value: 'payment-transfer-cash-registerCreate' },
    ],
  },
  {
  ...
  },
  {
    name: 'Depositos',
    permissions: [
      { name: 'Obtener', value: 'storageGet' },
      { name: 'Crear', value: 'storageCreate' },
      { name: 'Actualizar', value: 'storageUpdate' },
      { name: 'Borrar', value: 'storageDelete' },
    ],
  },
  {
    name: 'Depositos Stock',
    permissions: [{ name: 'Obtener', value: 'storage-stockGet' }],
  },
  {
    name: 'Clases de impuestos',
    permissions: [
      { name: 'Obtener', value: 'tax-classesGet' },
      { name: 'Crear', value: 'tax-classesCreate' },
      { name: 'Actualizar', value: 'tax-classesUpdate' },
      { name: 'Borrar', value: 'tax-classesDelete' },
    ],
  },
  {
    name: 'Tarifas de impuestos',
    permissions: [
      { name: 'Obtener', value: 'tax-ratesGet' },
      { name: 'Crear', value: 'tax-ratesCreate' },
      { name: 'Actualizar', value: 'tax-ratesUpdate' },
      { name: 'Borrar', value: 'tax-ratesDelete' },
    ],
  },
  {
    name: 'Entidas',
  ...
  },
  {
    ...
    permissions: [
      { name: 'Obtener', value: 'type-document-idGet' },
      { name: 'Crear', value: 'type-document-idCreate' },
      { name: 'Actualizar', value: 'type-document-idUpdate' },
      { name: 'Borrar', value: 'type-document-idDelete' },
    ],
  },
  {
    name: 'Usuarios',
  ...
  },
  {
    ...
    permissions: [
      { name: 'Obtener', value: 'wallet-accountGet' },
      { name: 'Crear', value: 'wallet-accountCreate' },
